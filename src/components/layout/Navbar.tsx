      ...
      <nav className={`sticky top-0 z-50 transition-all duration-300 ${
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-20 lg:h-24">
            ...
            {/* Logo Section - Animation removed */}
            <Link to="/" className="flex items-center gap-4">
              <div className="relative">
                {/* Removed glow effect and scale animation */}
            ...
            <div className="lg:hidden flex items-center gap-2">
              ...
              <Link to="/wishlist" className="relative p-2">
                ...
                {wishlist.length > 0 && (
                  <span className="absolute top-0 right-0 bg-orange-500 text-white w-4 h-4 rounded-full text-xs flex items-center justify-center">
                    {wishlist.length}
                  </span>
                )}
              </Link>
              ...
              <button
                ...
                className="p-2 rounded-lg bg-gray-100 hover:bg-orange-100 transition-colors duration-300"
              >
                {isOpen ? (
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-between mb-8">
              <div className="flex items-center gap-2">
                <img src="/ranjeet.png" alt="Logo" className="w-12 h-12" />
            ...
            {isAuthenticated && (
              <div className="mb-6 p-4 bg-gradient-to-r from-orange-50 to-orange-100 rounded-xl">
                <div className="flex items-center gap-3">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-orange-400 to-orange-500 flex items-center justify-center text-white font-bold text-lg">
                    {user?.name?.charAt(0) || 'U'}
                  </div>
                  <div>
            ...
            <div className="mt-6 pt-6 border-t border-gray-200">
              {isAuthenticated ? (
                ...
                <Link
                  to="/login"
                  onClick={() => setIsOpen(false)}
                  className="w-full flex items-center justify-center gap-2 px-4 py-3 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl hover:from-orange-600 hover:to-orange-700 transition-all duration-300 font-medium shadow-lg shadow-orange-200"
                >
